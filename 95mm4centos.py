...
def saveImage(resurls, header, i):
    ...
    try:
        ...
        maimpath = '/home/kricto/A_ACGN/M_萌小寒图包/L_【杂图】/M_【MM范】/'
...
def threadDomain():
    ...
    t1.start()
    t2 = threading.Thread(target=main, args=(2001,))
    t2.start()
    t3 = threading.Thread(target=main, args=(4001,))
    t3.start()
    t4 = threading.Thread(target=main, args=(6001,))
    t4.start()
    t5 = threading.Thread(target=main, args=(8001,))
    t5.start()
    t6 = threading.Thread(target=main, args=(10001,))
    t6.start()
    t7 = threading.Thread(target=main, args=(12001,))
    t7.start()
    t8 = threading.Thread(target=main, args=(14001,))
    t8.start()
    t9 = threading.Thread(target=main, args=(16001,))
    t9.start()
    t10 = threading.Thread(target=main, args=(18001,))
    t10.start()
    t11 = threading.Thread(target=main, args=(20001,))
    t11.start()
    t12 = threading.Thread(target=main, args=(22001,))
    t12.start()
    t13 = threading.Thread(target=main, args=(24001,))
    t13.start()
    t14 = threading.Thread(target=main, args=(26001,))
    t14.start()
    t15 = threading.Thread(target=main, args=(28001,))
    t15.start()
    t16 = threading.Thread(target=main, args=(30001,))
    t16.start()
