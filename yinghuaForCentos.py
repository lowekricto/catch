...
def mp4Save(animepara, videosurls):
    ...
    sendTask.append(fullpath)

    # 保存
    for x in videosurls:
        sendTask.append([x[1], fullpath + str(x[0]) + '.mp4'])

    TASK_LIST.append(sendTask)
